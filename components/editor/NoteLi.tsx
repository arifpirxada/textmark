...
const NoteLi = ({ note }: { note: Note }) => {
    return (
        <Link href={ `/notes/${note.id}` } className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg  group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
